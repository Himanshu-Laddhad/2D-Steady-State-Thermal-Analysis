...
#boundary conditions
lb_t = float(input("left boundary terature:"))
rb_t = float(input("right boundary terature:"))
tb_t = float(input("top boundary terature:"))
bb_t = float(input("bottom boundary terature:"))
#real boundary 
...
#initialising a matrix of weights for each cell center
...
#iterating to get approx value of temperature distribution
